...
-- Cloud-shared owner/admin passwords for no-email login.
-- This is intentionally readable/writable with the anon key for the internal static app model.
-- Do not store service_role keys in the frontend. If stronger security is required later,
-- move password verification and writes behind Supabase Edge Functions.
